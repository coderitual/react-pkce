...
function App() {
  ...
  return (
    <AuthContext>
      <h1>Auth Demo</h1>
      <p>We render the app inside an AuthContext.Provider. Nothing requires authentication yet.</p>
      <p>
        When you push "reveal", we will show something protected, you are only supposed to see it
      ...
      <p>
        Push the button below to show a component which uses useToken() incorrectly. It will result
        in a warning on the dev console, unless you are authenticated already.
      </p>
